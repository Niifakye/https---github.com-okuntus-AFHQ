        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-8 hover:border-blue-500 transition-all">
              ...
              <p className="text-slate-400 mb-4">
                <strong>Email:</strong> GHAF@gmail.com<br />
                <strong>Phone:</strong> 00233-00-000-00
              </p>
          ...
          <div className="bg-linear-to-br from-slate-800 to-slate-900 border border-blue-500/30 rounded-lg p-10">
            ...
            <form className="space-y-5">
              ...
              <button type="submit" className="w-full bg-linear-to-r from-blue-500 to-blue-700 py-3 rounded-lg font-bold text-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all mt-6">
                Submit
              </button>
            </form>
          </div>
